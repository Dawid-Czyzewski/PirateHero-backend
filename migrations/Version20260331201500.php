...
final class Version20260331201500 extends AbstractMigration
{
    ...
    private const TEST_SWORD_CODE = 'captain-cutlass-mark-ii';

    public function getDescription(): string
    {
        return 'Add second test sword to target user storage for item comparison.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $conn->executeStatement(
            'INSERT INTO wearable_item (statistics_id, name, type, rarity, price, public_code, level, image_key)
             VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
            [$statsId, 'Captain Cutlass Mk II', 'weapon', 'EPIC', 205, self::TEST_SWORD_CODE, 25, 'sword2']
        );
